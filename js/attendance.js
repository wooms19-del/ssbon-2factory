...
// ============================================================
// ★ 조직도(2026-08-31)에 맞춤 — '실장·파트장'과 'OP'는 독립 파트가 아니라
//   각자 소속 파트(해동/전처리·파쇄·내포장)로 편입됨. 직책은 position 필드로 표기.
var ATT_PART_ORDER=['해동/전처리','자숙/소스','파쇄','내포장','외포장','물류','공정QC','기술직선임','AR/도급'];
