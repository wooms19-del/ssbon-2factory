...
(function(){
  ...
  function ipDownload(){
    ...
    ws['!cols']=[{wch:12},{wch:10},{wch:34},{wch:12},{wch:15},{wch:15},{wch:13},{wch:13},{wch:16},{wch:16},{wch:15},{wch:16}];
    var wb=XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, '비가식부·생산성');
    var fname='비가식부생산성_'+(_ipYm||_ymToday())+(_ipType?'_'+_ipType:'')+'.xlsx';
