  ...
  function showPerfSub(name){
    ...
    if(pnav){
      pnav.querySelectorAll('.ti').forEach(function(t,i){
        t.classList.toggle('on', (i===0&&name==='daily') || (i===1&&name==='monthly') || (i===2&&name==='stock') || (i===3&&name==='mstock') || (i===4&&name==='inedible'));
      });
    }
    ...
    if(name==='daily'){
      ...
      var msPg = document.getElementById('p-mstock');
      if(msPg) msPg.classList.add('on');
      if(typeof renderMaterialStock === 'function') renderMaterialStock();
